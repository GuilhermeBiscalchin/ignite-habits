...
//para preencher um mínimo de quadrados de acordo com inicio de cada ano.
const minimunSummaryDatesSize = 18 * 7 // 18 semanas

//Para montar o minimo de quadrados, + descontar o que já é gerado automatico.
        ...
        <div className="w-full flex">
            ...
            <div className="grid grid-rows-7 grid-flow-col gap-3">
                ...
                {amountOfDaysToFill > 0 && Array.from({ length: amountOfDaysToFill }).map((_, i) => {
                    return (
                        <div key={i} className="w-10 h-10 bg-zinc-900 border-2 border-zinc-800 rounder-lg opacity-40 cursor-not-allowed"></div>
                    )
                })}
